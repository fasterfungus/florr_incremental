    ...
    Ui::Element* title = new Ui::VContainer({
                                                ...
                                                new Ui::Choose(
                                                    ...
                                                    new Ui::VContainer({
                                                                           ...
                                                                           new Ui::HContainer({
                                                                               new Ui::TextInput(
                                                                                   Game::nickname, 400, 50,
                                                                                   MAX_NAME_LENGTH, {
                                                                                       .line_width = 5,
                                                                                       .round_radius = 5,
                                                                                       .animate = [](
                                                                                       Element* elt, Renderer& ctx)
                                                                                       {
                                                                                           ctx.translate(
                                                                                               0, (elt->animation -
                                                                                                   1) * ctx.height *
                                                                           ...
                                                                           new Ui::StaticText(
                                                                               14, "(or press ENTER to spawn)")
                                                                       }, 10, 5, {
                                                                           .animate = [](Element* elt, Renderer& ctx)
                                                                           {
                                                                               ctx.translate(
                                                                                   0, (elt->animation - 1) * ctx.
                                                                                   height);
                                                                           }
                                                                       }),
    ...
    Element* elt = new Ui::Choose(
        ...
        new Ui::VContainer({
                               new Ui::HContainer({
                                                      ...
                                                      {
                                                          return std::format(
                                                              "You will respawn at level {}", Game::respawn_level);
                                                      }, {.fill = 0xffffffff, .no_animation = 1}),
                                                      new Ui::StaticText(16, " with:", {
                                                                             .fill = 0xffffffff,
                                                                             .should_render = []()
                                                                             {
                                                                                 if (!Game::simulation.ent_exists(
                                                                                     Game::camera_id)) return false;
                                                                                 return Game::simulation.get_ent(
                                                                                     Game::camera_id).get_inventory_ids(
                                                                                     0) > PetalID::kBasic;
                                                                             }
                                                                         })
                                                  }, 0, 0),
                               new Ui::HContainer(
                                   Ui::make_range(0, MAX_SLOT_COUNT, [](uint32_t i)
                                   {
                                       return (Element*)(new Ui::TitlePetalSlot(i));
                                   })
                                   , 0, 10),
                               new Ui::HContainer({
                                                      Ui::make_range(MAX_SLOT_COUNT, 2 * MAX_SLOT_COUNT, [](uint32_t i)
                                                      {
                                                          return (Element*)(new Ui::TitlePetalSlot(i));
                                                      })
                                                  }, 0, 10)
...
Element* Ui::make_debug_stats()
{
    Element* elt = new Ui::VContainer({
                                          new Ui::DynamicText(12, []()
                                          {
                                              ...
                                              return std::format("{} ctxs - {} pxls - {:.0f}x{:.0f}",
                                                                 Renderer::renderers.size(), format_score(pxls),
                                                                 Ui::window_width, Ui::window_height);
                                          }, {.fill = 0xffffffff, .h_justify = Style::Right}),
                                          new Ui::DynamicText(12, []()
                                          {
                                              if (Debug::frame_times.size() == 0) return std::string{
                                                  "Failed to show debug stats"
                                              };
                                              ...
                                              return std::format("tick: {:.1f}/{:.1f}/{:.1f} ms (min/avg/max)", min_dt,
                                                                 avg_dt, max_dt, 1000 / Ui::dt);
                                          }, {.fill = 0xffffffff, .h_justify = Style::Right}),
                                          new Ui::DynamicText(12, []()
                                          {
                                              if (Debug::frame_times.size() == 0) return std::string{
                                              ...
                                              return std::format(
                                                  "frame: {:.1f}/{:.1f}/{:.1f} ms (min/avg/max) - {:.1f} fps", min_dt,
                                                  avg_dt, max_dt, 1000 / Ui::dt);
                                          }, {.fill = 0xffffffff, .h_justify = Style::Right})
                                      }, 5, 5, {
                                          .should_render = []() { return Game::show_debug; }, .h_justify = Style::Right,
                                          .v_justify = Style::Bottom, .no_animation = 1
                                      });
    return elt;
}
...
Element* Ui::make_github_link_button()
{
    Element* elt = new Ui::HContainer({
                                          new Ui::Button(50, 50,
                                                         ...
                                                         [](Element* elt, uint8_t e)
                                                         {
                                                             if (e == Ui::kClick) DOM::open_page(
                                                                 "https://github.com/fasterfungus/florr_incremental");
                                                         },
                                                         nullptr,
